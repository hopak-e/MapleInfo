      ...
      <div className="flex flex-col items-center py-2 gap-y-1">
        ...
        {guildData && (
          <div className="flex flex-col">
              ...
              <div className="relative flex text-center text-[12px] gap-x-0.5">
                {guildData.guild_noblesse_skill &&
                  guildData.guild_noblesse_skill.map((item) => (
                    <div
                      key={item.skill_name}
                      className="px-1 pt-1 bg-dark-100 border-[0.2px] dark:boder-white rounded-sm cursor-pointer"
            ...
            <div className="grid grid-cols-2 grid-rows-3 min-w-[400px] md:grid-cols-5 md:grid-rows-1 grow shrink bg-dark-100 px-4 py-4 text-center rounded-sm">
